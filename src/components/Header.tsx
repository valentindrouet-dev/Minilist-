import { Plus, Menu, X, Settings, FileSpreadsheet, PlusSquare, Package, AlertTriangle } from 'lucide-react';
...
export function Header({ onAddClick, onMultiAddClick, onGameBoxClick, onSettingsClick, onImportExportClick, isLocalMode = false }: HeaderProps) {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            {isLocalMode && (
              <div className="hidden sm:flex items-center gap-1 px-2 py-1 bg-yellow-500/20 text-yellow-200 rounded text-xs" title="Les données sont stockées localement sur cet appareil">
            ...
            <div className="flex items-center gap-1 ml-2">
              ...
              {onMultiAddClick && (
                <button
                  ...
                  className="flex items-center gap-1 bg-white/90 text-primary-600 px-3 py-2 font-medium hover:bg-primary-50 transition border-l border-primary-200"
              ...
              {onGameBoxClick && (
                <button
                  ...
                  title="Ajouter une boîte de jeu"
                >
                  <Package size={20} />
                </button>
              )}
          ...
          <div className="md:hidden flex items-center gap-2">
            {isLocalMode && (
              <div className="flex items-center gap-1 px-1.5 py-1 bg-yellow-500/20 text-yellow-200 rounded text-xs" title="Mode local">
                <AlertTriangle size={12} />
              </div>
            )}
            <button
            ...
            <div className="flex items-center">
              ...
              {onMultiAddClick && (
                <button
                  onClick={onMultiAddClick}
                  className="p-2 bg-white/90 text-primary-600 border-l border-primary-200"
                  title="Ajouts multiples"
                >
                  <PlusSquare size={22} />
                </button>
